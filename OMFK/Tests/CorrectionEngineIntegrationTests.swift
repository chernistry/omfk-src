...
final class CorrectionEngineIntegrationTests: XCTestCase {
    ...
    func testRussianLayoutCorrection() async throws {
        ...
        XCTAssertNotNil(result.corrected, "Should detect and correct Russian typed on English layout")
    ...
    func testHebrewLayoutCorrection() async throws {
        ...
        XCTAssertNotNil(result.corrected, "Should detect and correct Hebrew typed on English layout")
        XCTAssertEqual(result.corrected, "שלום")
    }
    ...
    func testNoFalsePositivesForValidEnglish() async throws {
        ...
        XCTAssertNil(hello.corrected, "Valid English 'hello' should not be corrected")
        
        let world = await engine.correctText("world", expectedLayout: nil)
        XCTAssertNil(world.corrected, "Valid English 'world' should not be corrected")
    }
    ...
    func testNoFalsePositivesForValidRussian() async throws {
        ...
        XCTAssertNil(privet.corrected, "Valid Russian 'привет' should not be corrected")
    }
    ...
    func testNoFalsePositivesForValidHebrew() async throws {
        ...
        XCTAssertNil(shalom.corrected, "Valid Hebrew 'שלום' should not be corrected")
    }
    ...
    func testContextAwareness() async throws {
        ...
        XCTAssertEqual(first.corrected, "привет")
        ...
        if let corrected = second.corrected {
    ...
    func testShortTokenHandling() async throws {
        ...
        if let corrected = a.corrected {
            XCTAssertFalse(corrected.isEmpty)
        }
        if let corrected = ab.corrected {
            XCTAssertFalse(corrected.isEmpty)
        }
    }
    ...
    func testMixedScriptRejection() async throws {
        ...
        XCTAssertNil(mixed.corrected, "Mixed script text should not trigger correction")
    }
}
